    ...
    define(['jquery'], function ($) {
                        ...
                        if (btnOp.hasOwnProperty(ref)) {
                            ...
                            switch (ref) {
                                ...
                                case eventClick:
                                    ...
                                    break;
                                case 'text':
                                    //console.log(ref+' '+btnOp.key+' '+btnOp.text);
                                    var $index = btnOp.key;
                                    //console.log(ref);
        ...
        function _getModalInstance(skipEventChageIfExists,static) {
            ...
            function createModalElement(static) {
                ...
                return $('<div class="modal fade" tabindex="-1" '+static_content+'><style>.modal-xl{width:75%;}</style>'
            ...
            return alert({
                ...
                buttons: [
                  ...
                  //  { close: true, click: click, text: label[data.label] ? data.label : defaultSettings.confirmLabel }
                     { close: true, click: click,key:'cancel', text: data.label.cancel ? data.label.cancel : defaultSettings.confirmLabel.cancel, style: keyDanger },
                    { close: true, click: click, key:'ok',text: data.label.ok ? data.label.ok : defaultSettings.confirmLabel.ok }
                ],
                deferred: dfd,
        ...
        function iframe(params, title) {
           ...
           /* var html = ('<div class=modal-body style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%</div>' +
				...
				*/
			    var html = ('<div class=modal-body style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%</div>' +
                        '<iframe class="embed-responsive-item" frameborder=0 src="%0%" style="width:99%;height:'+params.height+'px;display:block;"/>')
                .replace('%0%', params.message || params.url || params)
                .replace('%1%', defaultSettings.loadingHtml);
